...
python ${python_path} optim --dataset_name yoshida_2021 --class_key Original_annotation --batch_key batch --mode entire_condition --obs_key batch --keep_obs AN1 AN11 AN12 AN13 AN3 AN6 AN7 --training_scheme training_scheme_1 --test_split_key TRAIN_TEST_split_batch 
#&> /home/acollin/dca_permuted_workflow/experiment_script/hp_runs/logs/yoshida_hyperparam_scheme_1.log
