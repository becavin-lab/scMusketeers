def get_training_scheme(training_scheme, run_file):
    ...
    if training_scheme == "training_scheme_7":
        training_scheme = [
            (
                "warmup_dann",
                run_file.warmup_epoch,
    ...
    if training_scheme == "training_scheme_8":
        training_scheme = [
            (
                "warmup_dann",
                run_file.warmup_epoch,
    ...
    if training_scheme == "training_scheme_9":
        training_scheme = [
            ("warmup_dann", run_file.warmup_epoch, False),
            ("full_model", run_file.fullmodel_epoch, True),
            ("classifier_branch", run_file.classifier_epoch, False),
    ...
    if training_scheme == "training_scheme_10":
        training_scheme = [
            (
                "warmup_dann",
                run_file.warmup_epoch,
    ...
    if training_scheme == "training_scheme_11":
        training_scheme = [
            (
                "warmup_dann",
                run_file.warmup_epoch,
    ...
    if training_scheme == "training_scheme_12":
        training_scheme = [
            (
                "permutation_only",
                run_file.warmup_epoch,
    ...
    if training_scheme == "training_scheme_13":
        training_scheme = [
            ("full_model", run_file.fullmodel_epoch, True),
            ("classifier_branch", run_file.classifier_epoch, False),
        ]

    if training_scheme == "training_scheme_14":
        training_scheme = [
            ("full_model", run_file.fullmodel_epoch, False),
            ("classifier_branch", run_file.classifier_epoch, False),
        ]

    if training_scheme == "training_scheme_15":
        training_scheme = [
    ...
    if training_scheme == "training_scheme_16":
        training_scheme = [
    ...
    if training_scheme == "training_scheme_17":
        training_scheme = [
            ("no_dann", run_file.fullmodel_epoch, True),
            ("classifier_branch", run_file.classifier_epoch, False),
        ]

    if training_scheme == "training_scheme_18":
        training_scheme = [
            ("no_dann", run_file.fullmodel_epoch, False),
            ("classifier_branch", run_file.classifier_epoch, False),
        ]

    if training_scheme == "training_scheme_19":
        training_scheme = [
            (
                "warmup_dann",
                run_file.warmup_epoch,
    ...
    if training_scheme == "training_scheme_21":
        training_scheme = [
            ("warmup_dann", run_file.warmup_epoch, False),
            ("no_dann", 100, False),
            ("classifier_branch", run_file.classifier_epoch, False),
    ...
    if training_scheme == "training_scheme_22":
        training_scheme = [
