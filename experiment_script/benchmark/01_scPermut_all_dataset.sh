...
do
    echo $dataset
    #$working_dir/01_scPermut_benchmark.sh $dataset Original_annotation batch
done

sh $working_dir/01_scPermut_benchmark.sh ajrccm_by_batch celltype manip
#01_scPermut_benchmark.sh htap ann_finest_level donor
#01_scPermut_benchmark.sh hlca_par_dataset_harmonized ann_finest_level dataset
#01_scPermut_benchmark.sh hlca_trac_dataset_harmonized ann_finest_level dataset
