...
def produce_fig_2(checkpoint_base_path, working_dir):
    ...
    logger.info("Generating Figure 2 Boxplots...")
    ...
    def generate_row_plot(metric_col, ylabel, output_filename, title="Figure 2"):
    ...
    generate_row_plot(
        ...
        output_filename="Figure_2_Balanced_Accuracy.png",
        title="Figure 2 - Balanced Accuracy"
    )
    
    generate_row_plot(
        metric_col="full_batch_mixing_entropy",
        ylabel="Batch mixing entropy", 
        output_filename="Figure_2_Entropy.png",
        title="Figure 2 - Entropy"
    )
